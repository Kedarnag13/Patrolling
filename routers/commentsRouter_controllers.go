...
func init() {
	...
	// beego.GlobalControllerRouter["github.com/Kedarnag13/Patrolling/controllers:UserController"] = append(beego.GlobalControllerRouter["github.com/Kedarnag13/Patrolling/controllers:UserController"],
	// 	beego.ControllerComments{
	// 		Method: "Post",
	// 		Router: `/`,
	// 		AllowHTTPMethods: []string{"post"},
